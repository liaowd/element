...
<script>
import Popper from '@liaowenda/element-ui/src/utils/vue-popper';
import Clickoutside from '@liaowenda/element-ui/src/utils/clickoutside';
import Emitter from '@liaowenda/element-ui/src/mixins/emitter';
import Locale from '@liaowenda/element-ui/src/mixins/locale';
import Migrating from '@liaowenda/element-ui/src/mixins/migrating';
import ElInput from '@liaowenda/element-ui/packages/input';
import ElTag from '@liaowenda/element-ui/packages/tag';
import ElScrollbar from '@liaowenda/element-ui/packages/scrollbar';
import ElCascaderPanel from '@liaowenda/element-ui/packages/cascader-panel';
import AriaUtils from '@liaowenda/element-ui/src/utils/aria-utils';
import { t } from '@liaowenda/element-ui/src/locale';
import { isEqual, isEmpty, kebabCase } from '@liaowenda/element-ui/src/utils/util';
import { isUndefined, isFunction } from '@liaowenda/element-ui/src/utils/types';
import { isDef } from '@liaowenda/element-ui/src/utils/shared';
import { addResizeListener, removeResizeListener } from '@liaowenda/element-ui/src/utils/resize-event';
