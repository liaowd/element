...
import { formatDate, parseDate, isDateObject, getWeekNumber } from '@liaowenda/element-ui/src/utils/date-util';
...
import merge from '@liaowenda/element-ui/src/utils/merge';
