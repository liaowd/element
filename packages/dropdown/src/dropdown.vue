<script>
  ...
  import ElButton from '@liaowenda/element-ui/packages/button';
  import ElButtonGroup from '@liaowenda/element-ui/packages/button-group';
  import { generateId } from '@liaowenda/element-ui/src/utils/util';
